     ...
     <main className='aboute'>
        <section className='glaboute'>
          <div className='aboutcount'>
            ...
            <h1 className='work'>ПОЛИТИКА КОНФИДЕНЦИАЛЬНОСТИ</h1>
            <div className='countext1'>
              <p className='textmal'>Главная ———</p>
              <p className='textblack'>Политика конфиденциальности</p>
            </div>
          </div>
        </section>
    </main>
